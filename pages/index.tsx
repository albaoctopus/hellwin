    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <a  className={styles.card}>
            ...
            <p>
              На нашей вечеринки было три темы. Какие скелеты в гараже? Культура в компании. Ночной кошмар или эликсир жизни? Страх и ненависть в digital-маркетинге. Ужасные истории из работы с клиентамиyarn.

              
              И по этим темам мы cоздали НФТ. Выпущены они в сети Polygon. Ограниченным тиражом, каждый по 50 экземпляров.
